...
if [ ! -e index.php ]; then
  ...
  ./wp --allow-root core install --url=localhost --title="Sweets, co." --admin_user=user --admin_password=password --admin_email=info@example.com
  ...
  ./wp --allow-root import wp-archive.xml --authors=create
fi
